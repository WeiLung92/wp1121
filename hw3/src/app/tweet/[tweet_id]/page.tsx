    ...
    <>
      <div className="flex h-screen w-full flex-col overflow-scroll pt-2">
        <div className="mb-2 flex items-center gap-8 px-4">
          ...
          <h1 className="text-xl font-bold">Join Me!</h1>
        </div>
        <div className="flex flex-row px-4 pt-3 items-center">
          <div className="flex flex-col gap-4 w-4/5 ">
              <div className="relative border-solid border-2 rounded-md  h-20 flex">
                <div className="absolute left-3 bottom-5 font-sans text-2xl ">{tweet.content}</div>
                <div className="absolute right-3 bottom-5 font-sans text-2xl ">{tweet.likes??0}人參加</div>
              </div>  
              <div className="relative border-solid border-2 rounded-md  h-20 flex">
                <div className="absolute left-3 bottom-5 font-sans text-2xl ">From {tweet.startAt} to {tweet.endAt}</div>
              </div>
          </div>
